...
const faqs = [
  {
    ...
    answer:
      "Não. A leitura do PDF, o reconhecimento das fotos e a criação do Word acontecem no seu próprio navegador. O Sim Doc não armazena o conteúdo dos documentos.",
  },
  {
      ...
      <section id="seguranca" className="section privacy-section">
        <div className="page-shell privacy-grid">
          ...
          <div className="privacy-copy">
            ...
            <p>
              A tecnologia do Sim Doc roda diretamente no navegador. Isso reduz riscos,
              elimina filas de processamento e permite usar a ferramenta sem criar uma conta.
            </p>
            <ul>
              <li><Check size={18} /> O conteúdo não é armazenado pelo Sim Doc</li>
